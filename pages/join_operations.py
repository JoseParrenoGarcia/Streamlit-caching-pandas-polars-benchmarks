...
if 'first_run_execution_time_csv_df' in st.session_state:
    ...
    with st.container(border=True):
        ...
        with st.container(border=True):
            ...
            with col1:
                with st.container(border=True):
                    st.plotly_chart(plot_execution_time_bar_charts(df=st.session_state.first_run_execution_time_join_df,
            ...
            with col2:
                with st.container(border=True):
                    diffs = calculate_percent_diff_execution_times(execution_time_df=st.session_state.first_run_execution_time_join_df,
        ...
        with st.container(border=True):
            ...
            st.write('If you havent clicked the **Join data** a second time, please do so that caching can take effect...')
            st.write('   ')
